      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center h-18">
          ...
          <div className="flex items-center text mr-4 gap-4 space-x-4">
            <Link to="/" className="text-white hover:text-black transition-colors">
              Dashboard
            </Link>
            <Link to="/calculator" className="text-white hover:text-black transition-colors">
              Calculator
            </Link>
            <Link to="/leaderboard" className="text-white hover:text-black transition-colors">
              Leaderboard
            </Link>
            <Link to="/history" className="text-white hover:text-black transition-colors">
              History
            </Link>
            <Link to="/community" className="text-white hover:text-black transition-colors">
              Community
            </Link>
            {isLoggedIn===true && <Link to="/profile">
